...
// "STEP" Comments by Nordic Semiconductor
...
/* function to register application callbacks for the LED and Button characteristics  */
...
/* function to send notifications for the MYSENSOR characteristic */
